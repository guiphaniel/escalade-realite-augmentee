...
class Game:
    ...
    def getPlayerPosition(self):
        ...
        playerPosition = [[landmark[15].x * 1920, landmark[15].y * 1080],
                          [landmark[16].x * 1920, landmark[16].y * 1080],
                          [landmark[17].x * 1920, landmark[17].y * 1080],
                          [landmark[18].x * 1920, landmark[18].y * 1080],
                          [landmark[19].x * 1920, landmark[19].y * 1080],
                          [landmark[20].x * 1920, landmark[20].y * 1080],
                          [landmark[21].x * 1920, landmark[21].y * 1080],
                          [landmark[22].x * 1920, landmark[22].y * 1080],
