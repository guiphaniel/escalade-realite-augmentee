...
def setup_logging(verbosity: int, no_color: bool, user_log_file: Optional[str]) -> int:
    ...
    handler_classes = {
        "stream": "pip._internal.components.logging.ColorizedStreamHandler",
        "file": "pip._internal.components.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "exclude_warnings": {
                    "()": "pip._internal.components.logging.MaxLevelFilter",
                ...
                "exclude_subprocess": {
                    "()": "pip._internal.components.logging.ExcludeLoggerFilter",
                    "name": subprocess_logger.name,
                },
            },
            "formatters": {
